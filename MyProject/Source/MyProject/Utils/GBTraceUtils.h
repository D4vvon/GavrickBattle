...
namespace GBTraceUtils
{
	...
	bool OverlapCapsuleAnyByProfile( const UWorld* World, const FVector& Pos, float CapsuleRadius, float CapsuleHalfHeight, FQuat Rot, FName ProfileName, const FCollisionQueryParams& QueryParamsm, bool bDrawDebug = false, float DrawTime = -1.0f, FColor HitColor = FColor::Red);
}